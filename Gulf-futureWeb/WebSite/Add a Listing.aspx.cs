    ...
    public partial class Add_a_Listing : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string mailbody = "<label>  Fullname : </label>  " + txtFullname.Text + "<br /><hr />" +
                ...
                if (img1.HasFile)
                {
                     ...
                     string fnameimg1 = Server.MapPath(ImagePath + img1.PostedFile.FileName);
                ...
                if (img2.HasFile)
                {
                     ...
                     string fnameimg2 = Server.MapPath(ImagePath + img2.PostedFile.FileName);
                ...
                if (img3.HasFile)
                {
                     ...
                     string fnameimg3 = Server.MapPath(ImagePath + img3.PostedFile.FileName);
                ...
                if (img4.HasFile)
                {
                     ...
                     string fnameimg4 = Server.MapPath(ImagePath + img4.PostedFile.FileName);
