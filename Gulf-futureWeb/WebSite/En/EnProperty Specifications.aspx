<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnProperty Specifications.aspx.cs" Inherits="WebSite.Property_Specifications" %>
...
<head>
    ...
    <title><%Response.Write(realStatProfile.EnOurService); %></title>
</head>
                            ...
                            <div class="block-content-inner">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <h2 class="h2center"><% Response.Write(realStatProfile.EnTitle); %> </h2>
                                        <hr>
                                        ...
                                        <h2 class="h2center">مواصفات العقار </h2>
                                ...
                                <br>
                                              ...
                                              <%
                                                  ...
                                                  Response.Write(realStatProfile.EnDescription);
                                        ...
                                        <div class="sidebar">
                                            <div class="sidebar-inner">
                                                ...
                                                <div class="widget">
                                                    ...
                                                    <h3 class="widget-title">عروض مميزة </h3>
                                                    ...
                                                    <%--    <div class="property-small clearfix">
                                                            ...
                                                            <div class="property-small-content col-sm-12 col-md-8" dir="rtl">
                                                                <h3 class="property-small-title"><a href="#">فيلا في الغبرة الشمالية </a></h3>
