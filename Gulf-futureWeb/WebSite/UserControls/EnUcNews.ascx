<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EnUcNews.ascx.cs" Inherits="WebSite.UserControls.EnUcNews" %>
        ...
        <div class="post clearfix">
            <div class="row">
                ...
                <div class="post-content col-sm-8">
                    <h3 class="post-title"><a href="NewsDetails.aspx?Rst=<%#Eval("ID") %>"><%#Eval("EnCaption") %> </a></h3>
                    <p>
                       <%#Eval("EnSummary") %>                        
                    </p>
                    <a href="NewsDetails.aspx?Rst=<%#Eval("ID") %>" >more </a>
                </div>
                <!-- /.post-content-->
            </div>
            <!-- /.row -->
